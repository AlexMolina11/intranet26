...
class StorePrestamoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'renovaciones_usadas' => ['nullable', 'integer', 'min:0'],
            'renovaciones_maximas' => ['nullable', 'integer', 'min:0'],
            'multa_diaria' => ['nullable', 'numeric', 'min:0'],
            'multa_acumulada' => ['nullable', 'numeric', 'min:0'],

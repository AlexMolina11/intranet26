...
C:\Sistemas2026\intranet26>php artisan route:list | findstr bib
  GET|HEAD  bib/config/autores bib.conf…
  POST      bib/config/autores bib.conf…
  GET|HEAD  bib/config/autores/crear bi…  
  PUT       bib/config/autores/{autor} …  
  GET|HEAD  bib/config/autores/{autor}/editar bib.config.autores.edit › App\Modules\Bib\Controllers\Config\AutorControll…     
  GET|HEAD  bib/config/clasificaciones …  
  POST      bib/config/clasificaciones …  
  GET|HEAD  bib/config/clasificaciones/crear bib.config.clasificaciones.create › App\Modules\Bib\Controllers\Config\ClasificacionController@…
  PUT       bib/config/clasificaciones/{clasificacion} bib.config.clasificaciones.update › App\Modules\Bib\Controllers\Config\ClasificacionC…
  GET|HEAD  bib/config/clasificaciones/{clasificacion}/editar bib.config.clasificaciones.edit › App\Modules\Bib\Controllers\Config\Clasi…
  GET|HEAD  bib/config/disponibilidades bib.config.disponibilidades.index › App\Modules\Bib\Controllers\Config\DisponibilidadController@inde…
  POST      bib/config/disponibilidades bib.config.disponibilidades.store › App\Modules\Bib\Controllers\Config\DisponibilidadController@stor…
  GET|HEAD  bib/config/disponibilidades/crear bib.config.disponibilidades.create › App\Modules\Bib\Controllers\Config\DisponibilidadController…
  PUT       bib/config/disponibilidades/{disponibilidad} bib.config.disponibilidades.update › App\Modules\Bib\Controllers\Config\Disponibilida…
  GET|HEAD  bib/config/disponibilidades/{disponibilidad}/editar bib.config.disponibilidades.edit › App\Modules\Bib\Controllers\Config\Disp…
  GET|HEAD  bib/config/editoriales bib.…  
  POST      bib/config/editoriales bib.…  
  GET|HEAD  bib/config/editoriales/crear bib.config.editoriales.create › App\Modules\Bib\Controllers\Config\EditorialController@crea…
  PUT       bib/config/editoriales/{editorial} bib.config.editoriales.update › App\Modules\Bib\Controllers\Config\EditorialControlle…
  GET|HEAD  bib/config/editoriales/{editorial}/editar bib.config.editoriales.edit › App\Modules\Bib\Controllers\Config\Editorial…
  GET|HEAD  bib/config/estados-ejemplar bib.config.estados-ejemplar.index › App\Modules\Bib\Controllers\Config\EstadoEjemplarController@inde…
  POST      bib/config/estados-ejemplar bib.config.estados-ejemplar.store › App\Modules\Bib\Controllers\Config\EstadoEjemplarController@stor…
  GET|HEAD  bib/config/estados-ejemplar/crear bib.config.estados-ejemplar.create › App\Modules\Bib\Controllers\Config\EstadoEjemplarController…
  PUT       bib/config/estados-ejemplar/{estadoEjemplar} bib.config.estados-ejemplar.update › App\Modules\Bib\Controllers\Config\EstadoEjempla…
  GET|HEAD  bib/config/estados-ejemplar/{estadoEjemplar}/editar bib.config.estados-ejemplar.edit › App\Modules\Bib\Controllers\Config\Esta…
  GET|HEAD  bib/config/estados-prestamo bib.config.estados-prestamo.index › App\Modules\Bib\Controllers\Config\EstadoPrestamoController@inde…
  POST      bib/config/estados-prestamo bib.config.estados-prestamo.store › App\Modules\Bib\Controllers\Config\EstadoPrestamoController@stor…
  GET|HEAD  bib/config/estados-prestamo/crear bib.config.estados-prestamo.create › App\Modules\Bib\Controllers\Config\EstadoPrestamoController…
  PUT       bib/config/estados-prestamo/{estadoPrestamo} bib.config.estados-prestamo.update › App\Modules\Bib\Controllers\Config\EstadoPrestam…
  GET|HEAD  bib/config/estados-prestamo/{estadoPrestamo}/editar bib.config.estados-prestamo.edit › App\Modules\Bib\Controllers\Config\Esta…
  GET|HEAD  bib/config/estados-solicitud bib.config.estados-solicitud.index › App\Modules\Bib\Controllers\Config\EstadoSolicitudController@ind…
  POST      bib/config/estados-solicitud bib.config.estados-solicitud.store › App\Modules\Bib\Controllers\Config\EstadoSolicitudController@sto…
  GET|HEAD  bib/config/estados-solicitud/crear bib.config.estados-solicitud.create › App\Modules\Bib\Controllers\Config\EstadoSolicitudControlle…
  PUT       bib/config/estados-solicitud/{estadoSolicitud} bib.config.estados-solicitud.update › App\Modules\Bib\Controllers\Config\EstadoSolici…
  GET|HEAD  bib/config/estados-solicitud/{estadoSolicitud}/editar bib.config.estados-solicitud.edit › App\Modules\Bib\Controllers\Config\Est…
  GET|HEAD  bib/config/etiquetas bib.co…  
  POST      bib/config/etiquetas bib.co…  
  GET|HEAD  bib/config/etiquetas/crear …  
  PUT       bib/config/etiquetas/{etiqueta} bib.config.etiquetas.update › App\Modules\Bib\Controllers\Config\EtiquetaController@u…
  GET|HEAD  bib/config/etiquetas/{etiqueta}/editar bib.config.etiquetas.edit › App\Modules\Bib\Controllers\Config\EtiquetaCon…
  GET|HEAD  bib/config/generos bib.conf…  
  POST      bib/config/generos bib.conf…  
  GET|HEAD  bib/config/generos/crear bi…  
  PUT       bib/config/generos/{genero} bib.config.generos.update › App\Modules\Bib\Controllers\Config\GeneroController@updat…
  GET|HEAD  bib/config/generos/{genero}/editar bib.config.generos.edit › App\Modules\Bib\Controllers\Config\GeneroControl…    
  GET|HEAD  bib/config/idiomas bib.conf…  
  POST      bib/config/idiomas bib.conf…  
  GET|HEAD  bib/config/idiomas/crear bi…  
  PUT       bib/config/idiomas/{idioma} bib.config.idiomas.update › App\Modules\Bib\Controllers\Config\IdiomaController@updat…
  GET|HEAD  bib/config/idiomas/{idioma}/editar bib.config.idiomas.edit › App\Modules\Bib\Controllers\Config\IdiomaControl…    
  GET|HEAD  bib/config/niveles-bibliograficos bib.config.niveles-bibliograficos.index › App\Modules\Bib\Controllers\Config\NivelBibliograficoControlle…
  POST      bib/config/niveles-bibliograficos bib.config.niveles-bibliograficos.store › App\Modules\Bib\Controllers\Config\NivelBibliograficoControlle…
  GET|HEAD  bib/config/niveles-bibliograficos/crear bib.config.niveles-bibliograficos.create › App\Modules\Bib\Controllers\Config\NivelBibliograficoCont…
  PUT       bib/config/niveles-bibliograficos/{nivelBibliografico} bib.config.niveles-bibliograficos.update › App\Modules\Bib\Controllers\Config\NivelBi…
  GET|HEAD  bib/config/niveles-bibliograficos/{nivelBibliografico}/editar bib.config.niveles-bibliograficos.edit › App\Modules\Bib\Controllers\Confi…
  GET|HEAD  bib/config/paises bib.confi…  
  POST      bib/config/paises bib.confi…  
  GET|HEAD  bib/config/paises/crear bib…  
  PUT       bib/config/paises/{pais} bi…  
  GET|HEAD  bib/config/paises/{pais}/editar bib.config.paises.edit › App\Modules\Bib\Controllers\Config\PaisController…       
  GET|HEAD  bib/config/tipos-acceso bib…  
  POST      bib/config/tipos-acceso bib…  
  GET|HEAD  bib/config/tipos-acceso/crear bib.config.tipos-acceso.create › App\Modules\Bib\Controllers\Config\TipoAccesoController@cre…
  PUT       bib/config/tipos-acceso/{tipoAcceso} bib.config.tipos-acceso.update › App\Modules\Bib\Controllers\Config\TipoAccesoControl…
  GET|HEAD  bib/config/tipos-acceso/{tipoAcceso}/editar bib.config.tipos-acceso.edit › App\Modules\Bib\Controllers\Config\TipoAcce…
  GET|HEAD  bib/config/tipos-adquisicion bib.config.tipos-adquisicion.index › App\Modules\Bib\Controllers\Config\TipoAdquisicionController@ind…
  POST      bib/config/tipos-adquisicion bib.config.tipos-adquisicion.store › App\Modules\Bib\Controllers\Config\TipoAdquisicionController@sto…
  GET|HEAD  bib/config/tipos-adquisicion/crear bib.config.tipos-adquisicion.create › App\Modules\Bib\Controllers\Config\TipoAdquisicionControlle…
Recurso} bib.config.tipos-recurso.update › App\Modules\Bib\Controllers\Config\TipoRecursoContr…
  GET|HEAD  bib/config/tipos-recurso/{tipoRecurso}/editar bib.config.tipos-recurso.edit › App\Modules\Bib\Controllers\Config\TipoRec…
  GET|HEAD  bib/dashboard bib.dashboard…

C:\Sistemas2026\intranet26>
@php
    $puedeGestionar = $puedeGestionar ?? auth()->user()->tienePermiso('BIB_SOLICITUDES_GESTIONAR');
@endphp

<div class="form-grid">
    @if($puedeGestionar)
        <div class="form-group">
            <label class="form-label" for="id_usuario">Usuario solicitante</label>
            <select name="id_usuario" id="id_usuario" class="form-control" required>
                <option value="">Seleccione</option>
                @foreach($usuarios as $usuario)
                    <option
                        value="{{ $usuario->id_usuario }}"
                        {{ (string) old('id_usuario', $solicitud->id_usuario ?? auth()->id()) === (string) $usuario->id_usuario ? 'selected' : '' }}
                    >
    ...
    <div class="form-group">
        <label class="form-label" for="id_recurso">Recurso solicitado</label>
    ...
    @if($puedeGestionar)
        <div class="form-group">
            <label class="form-label" for="id_ejemplar">Ejemplar asignado</label>
    ...
    <div class="form-group" style="grid-column: 1 / -1;">
        ...
        <textarea
            ...
            class="form-control"
            rows="3"
            placeholder="Ejemplo: Consulta, apoyo académico, préstamo para clase, investigación, etc."
    ...
    <div class="form-group" style="grid-column: 1 / -1;">
        ...
        <textarea
            ...
            class="form-control"
            rows="3"
            placeholder="Agrega cualquier detalle adicional para biblioteca."

                ...
                <tbody>
                    @forelse ($usuarios as $usuario)
                        <tr>
                            ...
                            <td>
                                <div class="actions">
                                    <a href="{{ route('seg.usuarios.edit', $usuario) }}" class="btn btn-warning">Editar</a>

                                    <a href="{{ route('org.usuarios.organizacion.edit', $usuario) }}" class="btn btn-secondary">Organización</a>
